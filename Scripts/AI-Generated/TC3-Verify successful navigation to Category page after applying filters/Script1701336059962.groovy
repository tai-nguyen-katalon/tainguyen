...
'step 7: At Page category click on button object'
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify successful navigation to Category page after applying filters_visual_checkpoint')
