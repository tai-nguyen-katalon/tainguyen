...
"Step 5: Click on link 'iPhone 15 Silicone Case with MagSafe' -> Navigate to page 'product/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Verify Viewing and Buying i Phone15 Silicone Case with Mag Safe_visual_checkpoint')
