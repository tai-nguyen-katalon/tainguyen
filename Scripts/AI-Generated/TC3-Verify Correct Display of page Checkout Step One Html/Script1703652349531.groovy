...
'step 3: Navigate to Page inventory html#code=0 ASsAPh27IWxyhE-TOVG8BZK --> navigate to Page checkout-step-one html'

WebUI.navigateToUrl(GlobalVariable.application_domain + '/checkout-step-one.html')

'step 4: Add visual checkpoint at Page checkout-step-one html'

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Correct Display of page Checkout Step One Html_visual_checkpoint')
