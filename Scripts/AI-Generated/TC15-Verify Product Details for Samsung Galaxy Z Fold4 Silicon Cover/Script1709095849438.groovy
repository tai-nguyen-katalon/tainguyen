...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_product/svg_object_2'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_product/svg_object_2'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Verify Product Details for Samsung Galaxy Z Fold4 Silicon Cover_visual_checkpoint')
