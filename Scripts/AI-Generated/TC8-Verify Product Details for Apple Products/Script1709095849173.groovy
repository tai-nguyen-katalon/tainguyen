...
"Step 3: Click on link 'Apple' -> Navigate to page 'product/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Verify Product Details for Apple Products_visual_checkpoint')
