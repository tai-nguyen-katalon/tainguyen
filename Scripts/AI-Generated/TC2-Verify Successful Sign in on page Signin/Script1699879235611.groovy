...
'step 3: Add visual checkpoint at Page signin'

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Successful Sign in on page Signin_visual_checkpoint')
