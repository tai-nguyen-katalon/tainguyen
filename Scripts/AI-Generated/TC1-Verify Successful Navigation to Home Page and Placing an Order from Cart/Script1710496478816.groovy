...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_category/hyperlink_place_an_order'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_category/hyperlink_place_an_order'))
...
"Step 8: Click on link 'K Cellphone Shop'"

WebUI.takeScreenshot()

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_cart/hyperlink_k_cellphone_shop'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/cart?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_cart/hyperlink_k_cellphone_shop'))

"Step 9: Click on link 'K Cellphone Shop' -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify Successful Navigation to Home Page and Placing an Order from Cart_visual_checkpoint')
